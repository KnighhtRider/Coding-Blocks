...
public:
		...
		void printInfo() const {
 		...
 		void constFunction() const {
 			counter++;
			 //cout<<getCredits()<<endl;You can call another const function from one const function
 		}
...
//We cannot change anything with setters of const objects.We can only call const functions of const 
//objects.
	Customer c3(c);
	return 0;
}
