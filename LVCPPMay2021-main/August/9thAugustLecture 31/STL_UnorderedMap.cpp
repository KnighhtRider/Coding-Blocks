...
int main() {
	...
	//pair<string,string> p("India","New Delhi");
	//capitalMap.insert(p);
	//        or
	capitalMap.insert(pair<string, string>("India", "New Delhi"));

	//pair<string,string> p=make_pair("USA","Washington");
	//capitalMap.insert(p);
	//           or
	capitalMap.insert(make_pair("USA", "Washington"));

	//pair<string,string> p={"Italy","Rome"};
	//capitalMap.insert(p);
	//         or
	...
	// using an iterator
	//unordered_map<string,string>::iterator it ,replace it with auto it
