...
//TC=O(NC)
//SC=O(NC+(N+C))  N+C Will be the height of recursive stack when all the weights will be 1 
//In one case we decrease N by 1 and in other he capacity by 1
...
//Time Complexity=O(NC) as there are (N+1)(C+1)Unique sub-problems
//Space Complexity=O(NC) for dp array
