...
//LIS2 is more space efficient that LIS-1 .TC is quadratic for both but space for  LIS-2 is linear
//and quadratic for LIS-1
#include<iostream>
#include<vector>
#include<climits>

using namespace std;
//Total number of nodes<n^n.TC=O(n^n+1)~O(n^n)
